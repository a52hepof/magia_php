...
<input type="hidden" name="c" value="buscar"> 
     ...
     <label for="clientes_tipo_documento" class="col-sm-2 control-label"><?php _t("Tipo_documento");?></label> 
     ...
     <div class="form-group"> 
     <label for="clientes_ruc_prefijo" class="col-sm-2 control-label"><?php _t("Ruc_prefijo");?></label> 
       <input type="text" class="form-control" name="clientes_ruc_prefijo" id="clientes_ruc_prefijo" placeholder="<?php _t("Ruc_prefijo"); ?> "> 
   </div> 


     <div class="form-group"> 
     <label for="clientes_numero_documento" class="col-sm-2 control-label"><?php _t("Numero_documento");?></label> 
     ...
     <div class="form-group"> 
     <label for="clientes_fecha_registro" class="col-sm-2 control-label"><?php _t("Fecha_registro");?></label> 
     ...
     <div class="form-group"> 
     <label for="clientes_es_cliente" class="col-sm-2 control-label"><?php _t("Es_cliente");?></label> 
