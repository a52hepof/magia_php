...
if (permisos_tiene_permiso($accion, $pagina, $_usuarios_grupo)) {
    ...
    // Si no hay fecha, ponemos la fecha de hoy
    
    if( ! isset($reservaciones_fecha_i)){
        $reservaciones_fecha_i = hoy();
    }
    ...
    include "./reservaciones/modelos/agenda.php";
    ...
    include "./reservaciones/vista/agenda.php";
} else {
