...
<form class="form-horizontal" action="index.php" method="post"> 
    ...
    <div class="form-group"> 
        ...
        <div class="col-sm-10"> 
            <select class="form-control" name="reservaciones_placa" >
                <?php autos_campo_add("placa"); ?>
            </select>
    ...
    <div class="form-group"> 
        ...
        <div class="col-sm-10"> 
            ...
            <select class="form-control" name="reservaciones_placa" >
                <?php reservaciones_hora_i_add($reservaciones_hora_i); ?>
            </select>


<?php /*<input type="text" class="form-control" name="reservaciones_hora_i" id="reservaciones_hora_i" placeholder="<?php _t("Hora i"); ?>" value=""   > */?>
