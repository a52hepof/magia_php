...
$total_traducido_p = number_format((_traducciones_total_segun_idioma($_idiomas_idioma) * 100) / _contenido_total(), 4);
...
echo ' <tr>
 ...
 <td>' . number_format(_traducciones_total_segun_idioma($_idiomas_idioma), 0) . ' / '. _contenido_total().'</td> 
 <td>' . $porcentaje . '</td> 
